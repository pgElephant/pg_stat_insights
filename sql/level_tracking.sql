...
SET pg_stat_insights.track = 'top';
...
END $$;
SELECT toplevel, calls, rows, query FROM pg_stat_insights
...
SELECT toplevel, calls, rows, query FROM pg_stat_insights ORDER BY query COLLATE "C";
...
--
-- pg_stat_insights.track = none
--
SET pg_stat_insights.track = 'none';
SELECT pg_stat_insights_reset() IS NOT NULL AS t;
