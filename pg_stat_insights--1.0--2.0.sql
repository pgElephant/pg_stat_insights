 ...
 *      Upgrade script from version 1.0 to 2.0
...
GRANT SELECT ON pg_stat_insights_logical_replication TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_slots TO PUBLIC;
GRANT SELECT ON pg_stat_insights_physical_replication TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_summary TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_alerts TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_wal TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_bottlenecks TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_conflicts TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_performance TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_health TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_timeline TO PUBLIC;
GRANT SELECT ON pg_stat_insights_subscriptions TO PUBLIC;
GRANT SELECT ON pg_stat_insights_subscription_stats TO PUBLIC;
GRANT SELECT ON pg_stat_insights_publications TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_origins TO PUBLIC;
GRANT SELECT ON pg_stat_insights_replication_dashboard TO PUBLIC;
